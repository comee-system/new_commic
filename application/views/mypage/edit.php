			...
			<div class="mx-auto w-100 mw1170 mt-3" >
				<form action="" method="POST" >
					...
					<div class="form-row mt-3 " role="group" >						
						<div class="col-md-4 col-6 "><input type="submit" name="regist" value="登録する" class="btn btn-primary w-100" /></div>
						<div class="col-md-4 col-6"><input type="submit" name="cancel" value="キャンセル" class="btn btn-secondary w-100" /></div>
					</div>
				</form>
			</div>
		</section>
